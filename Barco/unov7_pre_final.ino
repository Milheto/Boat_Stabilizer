...
void setup() {
  ...
  Serial.print("Roll offset inicial: ");
...
void loop() {
  ...
  // Debug
  Serial.print("Yaw esq: ");
  Serial.print(servo_pos_esq_yaw);
  Serial.print(" | Yaw dir: ");
  Serial.print(servo_pos_dir_yaw);
  Serial.print(" || Roll esq: ");
  Serial.print(servo_pos_esq_roll);
  Serial.print(" | Roll dir: ");
  Serial.println(servo_pos_dir_roll);

  // Motores
  esc_yaw.writeMicroseconds(1100);
  esc_roll.writeMicroseconds(1100);
}
